...
import com.inn.bakery.dao.ProductDao;
        ...
        try {
            if (jwtFilter.isAdmin()) {
                if (validateProductMap(requestMap, false)) {
                    ...
                    return BakeryUtils.getResponseEntity("Product Added Successfully", HttpStatus.OK);
                }
            ...
            if (jwtFilter.isAdmin()) {
                if (validateProductMap(requestMap, true)) {
                    ...
                    if(!optional.isEmpty()){
                        ...
                        return BakeryUtils.getResponseEntity("Product Updated Successfully", HttpStatus.OK);
                    } else {
                        return BakeryUtils.getResponseEntity("Product id does not exist.", HttpStatus.OK);
                    }
                } else {
                    return BakeryUtils.getResponseEntity(BakeryConstants.INVALID_DATA, HttpStatus.BAD_REQUEST);
                }
        ...
        try {
            if (jwtFilter.isAdmin()) {
                ...
                if(!optional.isEmpty()){
                    ...
                    return BakeryUtils.getResponseEntity("Product Deleted Successfully", HttpStatus.OK);
                }
                return BakeryUtils.getResponseEntity("Product id does not exist", HttpStatus.OK);
            }else {
                return BakeryUtils.getResponseEntity(BakeryConstants.UNAUTHORIZED_ACCESS, HttpStatus.UNAUTHORIZED);
        ...
        try {
            if (jwtFilter.isAdmin()) {
                ...
                if(!optional.isEmpty()){
                    ...
                    return BakeryUtils.getResponseEntity("Product Status Updated Successfully", HttpStatus.OK);
                }
                return BakeryUtils.getResponseEntity("Product id does not exist", HttpStatus.OK);
            }else{
                BakeryUtils.getResponseEntity(BakeryConstants.UNAUTHORIZED_ACCESS, HttpStatus.UNAUTHORIZED);
            }
        }catch (Exception ex) {
            ex.printStackTrace();
        }
