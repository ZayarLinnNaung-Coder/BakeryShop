        ...
        try {
            ...
            if (auth.isAuthenticated()) {
                ...
                if ("true".equalsIgnoreCase(userDetails.getStatus())) {
                    ...
                    String responseJson = String.format("{\"token\":\"%s\",\"id\":\"%s\", \"email\":\"%s\", \"role\":\"%s\", \"contactNumber\":\"%s\", \"name\":\"%s\"}",
                            token, userDetails.getId(), userDetails.getEmail(), userDetails.getRole(), userDetails.getContactNumber(), userDetails.getName());
